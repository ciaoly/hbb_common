...
pub const LINK_DOCS_HOME: &str = "https://127.0.0.1/docs/en/";
pub const LINK_DOCS_X11_REQUIRED: &str = "https://127.0.0.1/docs/en/manual/linux/#x11-required";
pub const LINK_HEADLESS_LINUX_SUPPORT: &str =
    "https://127.0.0.1/rustdesk/rustdesk/wiki/Headless-Linux-Support";

lazy_static::lazy_static! {
    pub static ref HELPER_URL: HashMap<&'static str, &'static str> = HashMap::from([
        ("rustwallpaper docs home", LINK_DOCS_HOME),
        ("rustwallpaper docs x11-required", LINK_DOCS_X11_REQUIRED),
        ("rustwallpaper x11 headless", LINK_HEADLESS_LINUX_SUPPORT),
        ]);
}
...
pub const RS_PUB_KEY: &str = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA=";
